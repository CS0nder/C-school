...
namespace RollTheDice.Tests;
    ...
    public class RollTheDiceTest
    {
        /*
            ...
            Also check if both fields have been set correctly.
        ...
        */
        ...
        {   
            ...
            Die die = new Die(Sides,Color);


            Assert.AreEqual(die.Sides, Sides);
            Assert.IsTrue(die.Sides <= Sides && die.Sides >= 1);
        ...
        /*
            ...
            Like in the Create_Die test, check if the value of a die does not exceed the specified sides.
        ...
        */
        ...
        {      
            string Color = "Red";
            Die diceobj = new Die(sides,Color);
            for (int roll =0; roll < 10; roll++)
            {
                diceobj.Roll();
                Assert.IsTrue(diceobj.Value >= 1 && diceobj.Value <= sides);
            }
        ...
        */
        ...
        {   
            ...
            DiceBag diceBagobj = new DiceBag();
            Assert.IsNotNull(diceBagobj.Dice);
            Assert.AreEqual(diceBagobj.Dice.Count, 0);
        ...
        */
        ...
        public void Add_DiceToDiceBag()
        {
            ...
            {   
                Die dieobj = new Die(side,"rood");
                diceBagobj.Add(dieobj);
                
                // create a die for each side in the lSides list
            }
            foreach (Die die in diceBagobj.Dice)
            {
                Assert.IsTrue(die.Value <= lSides.Max());
            }
            Assert.AreEqual(lSides.Count, diceBagobj.Dice.Count);
            CollectionAssert.AllItemsAreNotNull(diceBagobj.Dice);
